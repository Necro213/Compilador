...
public class CodigoIntermedio extends javax.swing.JDialog {
     ...
     */
    public CodigoIntermedio(java.awt.Frame parent, boolean modal, String cod) {
        super(parent, modal);
        initComponents();
        Codigo.setText(cod);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CodigoIntermedio dialog = new CodigoIntermedio(new javax.swing.JFrame(), true, new String());
